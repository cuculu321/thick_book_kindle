...
### 個人情報の取得と利用目的
本拡張機能には、個人情報を収集する機能はありません。

#### 取得方法
拡張機能内に、利用者が閲覧した`amazon.co.jp`を含む、ページから特定の情報をDOMを元に取得します。

#### 利用目的
##### 利便性の向上
拡張機能では、機能の内容により、下記の情報を取得します
- Amazon(Amazon.com, Inc.)の販売している書籍のページ数の情報

これにより、拡張機能によってページ数から本の厚さを可視化し、利便性が向上します。
